...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/suse/idoenmez/.config/ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/suse/idoenmez/.config/ipython'
...
# c.NotebookManager.notebook_dir = u'/suse/idoenmez'
