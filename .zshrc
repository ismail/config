...
alias clang="clang -std=c11 -Weverything -Wno-c++98-compat -O2 -g $EXTRA_CLANG_FLAGS"
alias clang++="clang++ -std=c++14 -Weverything -Wno-c++98-compat -O2 -g $EXTRA_CLANG_FLAGS"
